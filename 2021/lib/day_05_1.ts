...
//
// First attempt:
//  Use a dictionary to count overlaps for each point,
//  without storing any information for empty points.
//
//
// Complexity Analysis:
...
//              Includes ~10 minutes messing around with imports and configs
//  
//
...
function getPointsForSegment(segment: Segment): Point[] {
  ...
  if (start.x === end.x) {
    ...
    console.log(`Skipping diagonal segment (${formatSegment(segment)})`);
  }
