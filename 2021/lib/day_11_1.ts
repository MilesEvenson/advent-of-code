...
function parseSlug(slug: string): Cell {
  const [
    rawRow,
    rawCol,
    rawZ
...
function day11_1(): void {
  console.log('Welcome to Day 11.1. Watching the chain reaction.');
  ...
  // Finally, empty the dict and run the loop again.
  ...
  console.log(`Saw (${totalFlashes}) total flashes.`);
}
